package com.infologic.catalogos_service.entities;
...
@Data
@Entity
@Table(name = "CNRPOS_RCATALOGOS")
public class RCatalogos implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "rcatalogos_seq")
    @SequenceGenerator(name = "rcatalogos_seq", sequenceName = "RCATALOGOS_SEQ", allocationSize = 1)
